  ...
  const benefits = [
    {
      ...
      title: 'Native & Hybrid Support',
      description: 'Test iOS, Android, React Native, Flutter, and hybrid apps with unified frameworks and consistent quality.'
    },
    {
      icon: 'ri-device-line',
      title: 'Real Device Testing',
      description: 'Execute tests on real devices across different OS versions, screen sizes, and manufacturers for authentic results.'
    },
    {
      icon: 'ri-speed-line',
      title: 'Parallel Execution',
      description: 'Run tests simultaneously across multiple devices and platforms, reducing testing time by up to 80%.'
    },
    {
      icon: 'ri-gesture-line',
      title: 'Gesture & Touch Testing',
      description: 'Validate complex mobile interactions including swipes, pinch-to-zoom, multi-touch, and device rotation.'
    },
    {
      icon: 'ri-wifi-off-line',
      title: 'Network Simulation',
      description: 'Test app behavior under various network conditions including 3G, 4G, 5G, and offline scenarios.'
    },
    {
      icon: 'ri-battery-charge-line',
      title: 'Performance Monitoring',
      description: 'Track battery consumption, memory usage, CPU load, and app responsiveness during automated tests.'
    }
  ];

  const tools = [
    { name: 'Appium', category: 'Cross-Platform', icon: 'ri-smartphone-line' },
    { name: 'XCUITest', category: 'iOS Native', icon: 'ri-apple-line' },
    { name: 'Espresso', category: 'Android Native', icon: 'ri-android-line' },
    { name: 'Detox', category: 'React Native', icon: 'ri-reactjs-line' },
    { name: 'Flutter Driver', category: 'Flutter Apps', icon: 'ri-flutter-line' },
    { name: 'Sauce Labs', category: 'Cloud Testing', icon: 'ri-cloud-line' },
    { name: 'BrowserStack', category: 'Device Farm', icon: 'ri-server-line' },
    { name: 'TestNG', category: 'Test Framework', icon: 'ri-organization-chart' },
    { name: 'Cucumber', category: 'BDD Testing', icon: 'ri-file-text-line' },
    { name: 'Charles Proxy', category: 'Network Testing', icon: 'ri-wifi-line' }
  ];

  const useCases = [
    {
      industry: 'Mobile Banking',
      scenarios: ['Biometric authentication', 'Transaction processing', 'Push notifications', 'Offline mode functionality'],
      icon: 'ri-bank-card-line',
      color: 'emerald'
    },
    {
      industry: 'E-Commerce Apps',
      scenarios: ['Product browsing & search', 'Cart & checkout flows', 'Payment integration', 'Order tracking'],
      icon: 'ri-shopping-bag-line',
      color: 'orange'
    },
    {
      industry: 'Social Media',
      scenarios: ['Media upload & sharing', 'Real-time messaging', 'Feed scrolling performance', 'Camera integration'],
      icon: 'ri-chat-smile-line',
      color: 'violet'
    },
    {
      industry: 'Healthcare Apps',
      scenarios: ['Patient data security', 'Telemedicine features', 'Wearable device sync', 'HIPAA compliance'],
  ...
  const process = [
    {
      step: '01',
      title: 'App Analysis',
      description: 'Analyze your mobile app architecture, technology stack, and user flows to design an optimal automation strategy.',
      icon: 'ri-search-eye-line'
    },
    {
      step: '02',
      title: 'Framework Design',
      description: 'Build a scalable automation framework supporting multiple platforms with reusable components and page objects.',
      icon: 'ri-layout-grid-line'
    },
    {
      step: '03',
      title: 'Device Lab Setup',
      description: 'Configure cloud-based or on-premise device farms with comprehensive coverage of OS versions and devices.',
      icon: 'ri-server-line'
    },
    {
      step: '04',
      title: 'Test Script Development',
      description: 'Create robust test scripts handling platform-specific behaviors, gestures, and mobile-specific scenarios.',
      icon: 'ri-code-box-line'
    },
    {
      step: '05',
      title: 'CI/CD Integration',
      description: 'Integrate mobile tests into your build pipeline for automated testing on every app build and release.',
      icon: 'ri-git-branch-line'
    },
    {
      step: '06',
      title: 'Monitoring & Reporting',
      description: 'Provide detailed test reports with screenshots, videos, device logs, and performance metrics for every test run.',
  ...
  const faqs = [
    {
      ...
      answer: 'We primarily use real devices for accurate testing results. While emulators are useful for early development, real devices provide authentic user experience validation including hardware interactions, network conditions, and OS-specific behaviors.'
    },
    {
      question: 'Can you automate tests for both iOS and Android?',
      answer: 'Yes, we specialize in cross-platform automation using Appium for unified test scripts, as well as native frameworks (XCUITest for iOS, Espresso for Android) when platform-specific optimization is needed.'
    },
    {
      question: 'How do you handle app updates and OS changes?',
      answer: 'Our frameworks use resilient locator strategies and abstraction layers that minimize maintenance. We proactively update test scripts when new OS versions are released and provide ongoing maintenance as your app evolves.'
    },
    {
      question: 'What about testing on different screen sizes?',
      answer: 'We test across a comprehensive matrix of devices covering various screen sizes, resolutions, and aspect ratios. Our device selection is based on market share data and your target audience demographics.'
    },
    {
      question: 'Can you test apps that require special permissions?',
      answer: 'Absolutely. We handle camera access, location services, push notifications, biometric authentication, and other permission-based features through automated permission granting and mock services.'
    },
    {
      question: 'How long does mobile automation setup take?',
      answer: 'Initial framework setup typically takes 3-4 weeks including device lab configuration. First test scripts are usually running within 2 weeks, with full coverage achieved in 8-10 weeks depending on app complexity.'
    }
  ];
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-lg lg:text-xl text-white/90 mb-10 max-w-3xl leading-relaxed">
              Deliver flawless mobile experiences with comprehensive automation testing for iOS and Android. Test on real devices with complete coverage of gestures, network conditions, and platform-specific behaviors.
            </p>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 lg:mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Why Mobile Automation Matters</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">Ensure consistent quality across all mobile platforms with automated testing that scales.</p>
            </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Mobile Testing Tools</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">Cutting-edge frameworks for native, hybrid, and cross-platform mobile testing.</p>
            </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Mobile App Testing Across Industries</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">Specialized mobile automation for your industry's unique requirements.</p>
            </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12 lg:mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Mobile Automation Delivery</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">A structured approach to building robust mobile test automation.</p>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6">Ready to Automate Your Mobile Testing?</h2>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">Let's build a mobile automation strategy that ensures quality across all devices and platforms.</p>
