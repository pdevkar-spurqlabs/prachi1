...
import { podcastStats } from '../../../../mocks/podcastEpisodes';
    ...
    <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-28 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div
            className={`flex items-end justify-center gap-1 mb-6 h-8 transition-all duration-700 ${
          ...
          >
            {[...Array(5)].map((_, i) => (
              <div
                ...
                style={{
                  animation: `sound-wave ${0.6 + i * 0.15}s ease-in-out infinite`,
          ...
          >
            Deep conversations with industry leaders about QA strategies, test automation, performance engineering,
            and the future of software quality.
          </p>
      ...
      <div className="absolute bottom-0 left-1 right-1 h-24 bg-gradient-to-t from-white to-transparent" />
      {/* Use a regular <style> tag (not self‑closing) to avoid JSX parsing errors */}
      <style dangerouslySetInnerHTML={{ __html: keyframesStyle }}></style>
    </section>
  );
}
