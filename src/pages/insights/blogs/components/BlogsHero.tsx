...
import { blogStats } from '../../../../mocks/blogPosts';
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className={`flex items-center justify-center gap-3 mb-6 transition-all duration-700 ${visible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="w-12 h-12 flex items-center justify-center" style={{ animation: 'pen-write 3s ease-in-out infinite' }}>
              <i className="ri-quill-pen-line text-3xl text-orange-400" />
            </div>
            <div className="w-8 h-8 flex items-center justify-center" style={{ animation: 'page-flip 4s ease-in-out infinite' }}>
              <i className="ri-file-text-line text-lg text-amber-400/60" />
            </div>
          </div>
          ...
          <p className={`text-lg lg:text-xl text-gray-300 mb-10 leading-relaxed max-w-3xl mx-auto transition-all duration-700 delay-200 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            Deep dives into test automation, performance engineering, security testing, and the latest QA trends — written by practitioners who solve real-world quality challenges every day.
          </p>
          ...
          <div className={`flex flex-wrap justify-center gap-4 mb-14 transition-all duration-700 delay-300 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            <a href="#articles" className="px-7 py-3.5 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white text-sm font-semibold rounded-full transition-all duration-300 shadow-lg shadow-orange-500/25 cursor-pointer whitespace-nowrap flex items-center gap-2">
              <span className="w-5 h-5 flex items-center justify-center"><i className="ri-book-read-line text-base" /></span>
              Browse Articles
            </a>
            <a href="#featured" className="px-7 py-3.5 border border-gray-500 hover:border-orange-400 text-white text-sm font-semibold rounded-full transition-all duration-300 cursor-pointer whitespace-nowrap flex items-center gap-2">
              <span className="w-5 h-5 flex items-center justify-center"><i className="ri-star-line text-base" /></span>
              Featured Post
            </a>
          </div>
